#!/bin/bash
#SBATCH --job-name=mto-bsm
#SBATCH --partition=gpu_a800
#SBATCH --gpus=1
#SBATCH --time=00:30:00
#SBATCH --output=outputs/logs/slurm/smoke_stage_b_%j.out
#SBATCH --error=outputs/logs/slurm/smoke_stage_b_%j.err
...
$PYTHON -u scripts/train_stage.py \
  ...
  --save-cache \
  --plot-mto \
  --checkpoint-dir outputs/smoke_stage_b/checkpoints
